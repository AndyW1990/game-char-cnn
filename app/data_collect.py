...
def get_char_img(char_soup):
    try:
        ...
        img_url, image_fname, img_h, img_w = 'N/A', 'N/A', 'N/A', 'N/A'     
...
columns = ['Name', 'Image fName', 'Image Height', 'Image Width', 'Image URL', 'Alignment']
...
df = pd.concat((df,accumulator))            
df.to_csv('../data.game_chars.csv')
